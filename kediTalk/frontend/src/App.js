...
import OriginalLoginModal from './components/Modal/OriginalLoginModal';
    ...
    <>
      <div className="App">
        <div className="auto-margin">
          ...
          <Route exact path="/originallogin">
            <OriginalLoginModal setModal={setModal} userHasAuthenticated={userHasAuthenticated}/>
          </Route>
          ...
          <Route exact path="/register">
            <RegisterModal setModal={setModal} userHasAuthenticated={userHasAuthenticated}/>
          </Route>
