          ...
          <div className="login-head">
            {
                <div className="head">
                  ...
                  <div className="head-link" onClick={(e)=>{
                    e.preventDefault()
                ...
                <input type="text" placeholder="이메일을 입력하세요" onChange={handleNameChange}/>
                <label>Password:</label>
                <input type="password" placeholder="비밀번호를 입력하세요" onChange={handlePasswordChange}/>
                <label>Confirm Password:</label>
                <input type="password" placeholder="비밀번호를 다시 입력하세요" onChange={handleConfirmPasswordChange}/>
                {/* https://hianna.tistory.com/437 */}
                <div className="selectbox">
                  <div className="selectitem">
                    <label>Country: </label>
                      <select id="userCountry" onChange={handleCountryChange}>
                    ...
                    <label>Language: </label>
                      <select id="userLanguage" onChange={handleLanguageChange}>
                ...
                //   console.log('language: ', language)
                  ...
                  console.log('register/EndOfClikEvent');
                }}
                >Join</button>
            
          </form>
          <section className="social-box">
            <h4>Join with Social Account</h4>
